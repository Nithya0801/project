...
<body>
	...
	<br>
	<br>
	<form action="${pageContext.request.contextPath}/admin/upPro"
		...
		Product Name : <input type="text" name="pname"
			value="<%=p.getPname()%>" required /><br> <br> Product
		Description : <input type="text" name="desc" value="<%=p.getDesc()%>"
			required /><br> <br> Product Price : <input type="number"
			name="price" value="<%=p.getPrice()%>" required /><br> <br>
		Product Stock : <input type="number" name="stock"
			value="<%=p.getStock()%>" required /><br>
		<%
			}
		%>
		<br> Category List:<select name="cat" required>
			...
			%>--%>
		</select><br> <br> Image File: <input type="file" name="file"
